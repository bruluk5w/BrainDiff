...
class QVTKRenderWindowInteractor(QVTKRWIBaseClass):
    ...
    def __init__(self, parent=None, **kw):
        ...
        self._iren_observers = [
            self._Iren.AddObserver('CreateTimerEvent', self.CreateTimer),
            self._Iren.AddObserver('DestroyTimerEvent', self.DestroyTimer),
        ]

        self._window_observer = self._Iren.GetRenderWindow().AddObserver('CursorChangedEvent', self.CursorChangedEvent)
    ...
    def Finalize(self):
        ...
        '''
        self._Iren.GetRenderWindow().RemoveObserver(self._window_observer)
        for o in self._iren_observers:
